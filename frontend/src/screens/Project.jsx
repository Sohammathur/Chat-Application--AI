...
import 'highlight.js/styles/nord.css'; // theme

let getWebContainer;
try {
  getWebContainer = require('../config/webcontainer').getWebContainer;
} catch (err) {
  console.warn("WebContainer not available on server-side build.");
}
